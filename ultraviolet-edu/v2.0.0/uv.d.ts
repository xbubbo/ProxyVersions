const Ultraviolet: typeof import('@titaniumnetwork-dev/v2.0.0/src/rewrite').default;
const UVClient: typeof import('@titaniumnetwork-dev/v2.0.0/src/client').default;
